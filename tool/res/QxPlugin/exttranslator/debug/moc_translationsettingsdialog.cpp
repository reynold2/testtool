...
struct qt_meta_stringdata_TranslationSettingsDialog_t {
    QByteArrayData data[7];
    char stringdata0[112];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_TranslationSettingsDialog_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_TranslationSettingsDialog_t qt_meta_stringdata_TranslationSettingsDialog = {
    {
QT_MOC_LITERAL(0, 0, 25), // "TranslationSettingsDialog"
QT_MOC_LITERAL(1, 26, 17), // "on_btnAdd_clicked"
QT_MOC_LITERAL(2, 44, 0), // ""
QT_MOC_LITERAL(3, 45, 20), // "on_tableView_clicked"
QT_MOC_LITERAL(4, 66, 5), // "index"
QT_MOC_LITERAL(5, 72, 20), // "on_btnDelete_clicked"
QT_MOC_LITERAL(6, 93, 18) // "on_btnSave_clicked"

    },
    "TranslationSettingsDialog\0on_btnAdd_clicked\0"
    "\0on_tableView_clicked\0index\0"
    "on_btnDelete_clicked\0on_btnSave_clicked"
};
...
const QMetaObject TranslationSettingsDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_TranslationSettingsDialog.data,
      qt_meta_data_TranslationSettingsDialog,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *TranslationSettingsDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_TranslationSettingsDialog.stringdata0))
