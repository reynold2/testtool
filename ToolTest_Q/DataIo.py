...
class Excel_io(object):
    # def __init__(self, defaultexcelpath=PATHDATA["TestCase"], **kw):
...
if __name__ == "__main__":
    ...
    e.excelpath = "G:/Python3/layout/ToolTest_Q/RE/report.xls"
    print(e.ReadEXcleData())
    e.excelpath = "G:/Python3/layout/ToolTest_Q/report.xls"
