...
'''
from PyQt5.QtWidgets import QMainWindow, QAction, QSizePolicy, QMessageBox, QLCDNumber, qApp, QVBoxLayout
from PyQt5.QtCore import QTimer,Qt,pyqtSlot
from ToolTest_Q.CentralView import CentralView
from ToolTest_Q.ProfileWizard import *
